...
<body class="">
    <div class="row">
    <div class="col-lg-3 col-sm-0 fix">
        <div>
            <p class="ml-5"><span class="text-warning big2">M</span><span class="lit2">social</span></p>
        </div>
        <div class="pl-4">
            <ul>
                <a href="feed" class="silist"><li class=""><span class="sicon mr-3"><i class="fas fa-home"></i></span><span class="stext">Home</span></li></a>
                ...
                <a href="discover" class="silist"><li class="mt-3 text-warning"><span class="sicon mr-3"><i class="fas fa-ellipsis-h text-warning"></i></span><span class="stext">Discover</span></li></a>
    ...
    <div class="bbotbig">
        <nav class="navbar navbar-expand-lg navbar-light bg-light container-fluid">
            ...
            <div class="nav-item ml-1">
               <input name="post" type="text" class="form-control pt-3 bg-light text-dark ml-2" placeholder="What's Happening?" width="100%" style="border: none; outline:none; font-size: large;"></b>
            </div>
