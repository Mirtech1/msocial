    ...
    <div class="col-lg-3 col-sm-3">
        ...
        <div class="pl-4">
            <ul>
                ...
                <a href="videos" class="silist"><li class="mt-3 text-warning"><span class="sicon mr-3"><i class="fas fa-video text-warning"></i></span><span class="stext">Videos</span></li></a>
