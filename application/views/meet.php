    ...
    <div class="col-lg-3 col-sm-0">
        ...
        <div class="pl-4">
            <ul>
                ...
                <a href="meet" class="silist"><li class="mt-3 text-warning"><span class="sicon mr-3"><i class="fas fa-user-friends text-warning"></i></span><span class="stext">Meet</span></li></a>
